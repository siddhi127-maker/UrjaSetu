...
export default function Signup({ onLogin }) {
  ...
  return (
    <div className="auth-page">
      ...
      {/* Google OAuth-style Sign-Up Modal */}
      {showGoogleModal && (
          ...
          <div className="google-oauth-modal" onClick={(e) => e.stopPropagation()}>
            ...
            {googleStep === 1 && (
              <form onSubmit={handleGoogleEmailStep} className="google-oauth-form">
                <h3 className="google-oauth-title">Create account</h3>
                ...
                <div className="google-oauth-field">
                  <input
                    ...
                    autoComplete="email"
                  />
                  <label htmlFor="google-signup-email">Email</label>
                </div>

                <p className="google-oauth-help">
                  Enter your Google Account email to create your UrjaSetu profile. Your dispatch history and settings will be saved privately to your account.
                </p>

                <div className="google-oauth-actions">
                  <button type="button" className="google-oauth-link" onClick={() => { closeGoogleModal(); navigate('/login'); }}>
                    Sign in instead
                  </button>
            ...
            {googleStep === 2 && (
              <div className="google-oauth-form">
                ...
                <div className="google-oauth-field">
                  <input
                    ...
                    placeholder=" "
                  />
                  <label htmlFor="google-signup-name">Display name</label>
                </div>

                <p className="google-oauth-consent">
                  By continuing, Google will share your name and email address with UrjaSetu. Review the app's{' '}
                  <span className="google-oauth-consent-link">privacy policy</span> and{' '}
                  <span className="google-oauth-consent-link">terms of service</span>.
                </p>
